...
public class StaffUI extends JFrame
{
  ...
  /**
   * Constructor to create a new Staff User Interface
   *
   * @param staffID the staffID number
   * @param firstName the staff's first name
   * @param posit the staff's position
   **/
  ...
  public class CustomerListener implements ActionListener
  {
	...
	if (customerList.getSelectedIndex() != -1) //does not equal no selection
	{
	  ...
	  ViewCustomerUI viewCustUI = new ViewCustomerUI(customerSurname);
  ...
  public class StaffOrderListener implements ActionListener
  {
	...
	ViewStaffOrderQuery viewStOrdUI 
	  = new ViewStaffOrderQuery(staffOrderNumber);
