...
public class CDSearchQuery
{
  ...
  /**
   * Constructor to create a new CD search query
   *
   * @param a the artist name
   * @param cd_n the cd title
   **/
  ...
  public ArrayList exeQuery()
  {
	...
	iid = rs0.getString("iid");
      ...
      while(rs1.next())
      {
	cdArrayList.add(rs1.getString("iid"));
	cdArrayList.add(rs1.getString("cd_name"));
	cdArrayList.add(rs1.getString("artist"));
	cdArrayList.add(rs1.getString("genre"));
	cdArrayList.add(rs1.getString("type"));
	cdArrayList.add(rs1.getString("release_date"));
