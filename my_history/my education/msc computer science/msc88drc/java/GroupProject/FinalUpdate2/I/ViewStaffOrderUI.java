...
/**
   A java Swing application that displays an individual staff order 
...
class ViewStaffOrderUI extends JFrame
{
  ...
  /**
   * Constructor to create a new Staff Order viewer
   *
   * @param theStaffOrder the staff order elements
   **/
  public ViewStaffOrderUI(ArrayList theStaffOrder)
  {
    ...
    staffON = (String)staffOrder.get(0);
    staffID = (String)staffOrder.get(1);
    staffD = (String)staffOrder.get(2);
    supID = (String)staffOrder.get(3);
  ...
  /**
   * Inner class, used to listen for interface events
   **/
