...
/**
   Used by ViewStockLevelsUI, inputs an arraylist of stock data, updates 
   the stock entry, returns an arrayList of the updated stock entry details
...
public class UpdateStockEntryQuery
{
   ...
   * Execute the query
   * 
   * @return an arraylist of stock level details
   **/
