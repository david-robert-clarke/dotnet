...
class TestPerson
{
    public static void main(String[] args)throws IdentityException,GenderException
    {
        ...
        */
        ...
        //helen.setMother(fred);
        //helen.setMother(null);
        // helen.setFather(null);

        fred.removeAllChildren();
        System.out.println(dave1.getFather());//p1
        System.out.println(helen.getFather());//p2
        System.out.println(alan.getFather());//p3
        System.out.println(winnie.hasChild(fred));//p4
        System.out.println(charlie.hasChild(fred));//p5
        
        winnie.removeChild(fred);
        charlie.removeChild(fred);
        System.out.println(dave1.getFather());//p1
        System.out.println(helen.getFather());//p2
        System.out.println(alan.getFather());//p3
        System.out.println(winnie.hasChild(fred));//p4
       ...
       */
       ...
       System.out.println(charlie.getNumberOfChildren());
       System.out.println(charlie.getFather());
       System.out.println(charlie.getMother());

       System.out.println(fred.getNumberOfChildren());//p1
       System.out.println(fred.getFather());//p2
       System.out.println(fred.getMother());//p3

       System.out.println(margaret.getNumberOfChildren());//p1
       System.out.println(margaret.getFather());//p2
       System.out.println(margaret.getMother());//p3

       System.out.println(christine.getNumberOfChildren());//p1
       System.out.println(christine.getFather());//p2
       System.out.println(christine.getMother());//p3

       System.out.println(hazel.getNumberOfChildren());//p1
       System.out.println(hazel.getFather());//p2
       System.out.println(hazel.getMother());//p3

       System.out.println(dave2.getNumberOfChildren());//p1
       System.out.println(dave2.getFather());//p2
       System.out.println(dave2.getMother());//p3

       System.out.println(dave1.getNumberOfChildren());//p1
       System.out.println(dave1.getFather());//p2
       System.out.println(dave1.getMother());//p3

       System.out.println(helen.getNumberOfChildren());//p1
       System.out.println(helen.getFather());//p2
       System.out.println(helen.getMother());//p3

       System.out.println(alan.getNumberOfChildren());//p1
       System.out.println(alan.getFather());//p2
       System.out.println(alan.getMother());//p3

       System.out.println(joanna.getNumberOfChildren());//p1
       System.out.println(joanna.getFather());//p2
       System.out.println(joanna.getMother());//p3

       System.out.println(paul.getNumberOfChildren());//p1
       System.out.println(paul.getFather());//p2
       System.out.println(paul.getMother());//p3

       System.out.println(sarah.getNumberOfChildren());//p1
       System.out.println(sarah.getFather());//p2
       System.out.println(sarah.getMother());//p3

       System.out.println(neil.getNumberOfChildren());//p1
       System.out.println(neil.getFather());//p2
       System.out.println(neil.getMother());//p3
        */
        /*
       System.out.println(helen); 	//point1
       System.out.println(dave1); 	//point2
       System.out.println(alan ); 	//point3
       System.out.println(fred ); 	//point4 
       System.out.println(margaret ); 	//point5
       System.out.println(dave2); 	//point6
       System.out.println(richard); 	//point7
       System.out.println(neil); 	//point8
       System.out.println(hazel); 	//point9
       System.out.println(gaynor); 	//point10
       System.out.println(joanna); 	//point11
       System.out.println(christine);  	//point12
       System.out.println(paul); 	//point13
       System.out.println(sarah); 	//point14
        */
