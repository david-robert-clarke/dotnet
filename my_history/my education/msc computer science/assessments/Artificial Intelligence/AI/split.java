...
class split
{
    ...
    private static int featureValue (int i, Patient p)
    {
        ...
        switch (i)
            {
            case 0: temp = Integer.parseInt(p.getAge());
	if (temp < 45)
	    {
	        returnVal = 0;
	    }
	...
	break;
            ...
            case 2: temp = Integer.parseInt(p.getDiameter());
	if (temp < 6)
	    {
	        returnVal = 0;
	    }
	...
	break;
            ...
            case 3: returnVal = Integer.parseInt(p.getCollBin());
	break;
      
            case 4: returnVal = Integer.parseInt(p.getBgBin());
	break;
      
            case 5: returnVal = Integer.parseInt(p.getBlDisp());
	break;
      
            case 6: returnVal = Integer.parseInt(p.getBlBlus());
	break;
     
            case 7: returnVal = Integer.parseInt(p.getDerMel());
	break;
      
            case 8: returnVal = Integer.parseInt(p.getDmGlob());
	break;
      
            case 9: returnVal = Integer.parseInt(p.getAsym());
	break;
      
            case 10: returnVal = Integer.parseInt(p.getSym1());
	break;
      
            case 11: returnVal = Integer.parseInt(p.getSym2());
	break;
      
            case 12: returnVal = Integer.parseInt(p.getMelGlob());
	break;  
      
            case 13: returnVal = Integer.parseInt(p.getDispBlus());
	break; 
      
            case 14: returnVal = Integer.parseInt(p.getDiam6());
	break;   	
      
            case 15: returnVal = Integer.parseInt(p.getNoSym2());
	break;   
     
            case 16: temp = Integer.parseInt(p.getSize());
	if (temp == 0)
	    {
	        returnVal = 0;
	    }
	...
	break; 
            ...
            case 17: temp = Integer.parseInt(p.getShape());
	if (temp == 0)
	    {
	        returnVal = 0;
	    }
	...
	break;
            ...
            case 18: returnVal = Integer.parseInt(p.getColour());
	break;

            case 19: returnVal = Integer.parseInt(p.getInflamed());
	break;
        
            case 20: returnVal = Integer.parseInt(p.getBleed());
	break;

            case 21: returnVal = Integer.parseInt(p.getSens());
	break;   

            case 22: returnVal = Integer.parseInt(p.getDiam7());
	break;
      
            case 23: returnVal = Integer.parseInt(p.getTotal());
	break;

            case 23: returnVal = Integer.parseInt(p.getSuspicious());
	break;
    ...
    // ADD TO THE FEATURE STRING METHOD
