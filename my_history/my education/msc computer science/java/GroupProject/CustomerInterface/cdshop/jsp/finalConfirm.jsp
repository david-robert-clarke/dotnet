...
%>
  <tr>
    ...
    <font style="font-size: 10.0pt; font-family: Times New Roman">
        <A HREF="product/Product.jsp?ISBN=<%= prod.getCdId() %>">
        <%= prod.getTitle() %></A>
    </span><BR><BR></td>
  ...
  <span style="font-size: 10.0pt; font-family: Times New Roman">
    ...
    <TD>
  <span style="font-size: 10.0pt; font-family: Times New Roman">
   <font color=#990000>&pound;<%= cart.getShippingString(orderaddr).substring(1)%></font>
  </span></TD></TR>
  <TR><TD>&nbsp;</TD>
  <TD>&nbsp</TD>
  <TD ALIGN="center">
  <span style="font-size: 10.0pt; font-family: Times New Roman">
    ...
    <TD>
  <span style="font-size: 10.0pt; font-family: Times New Roman">
   <font color=#990000>&pound;<%= cart.getTaxString(orderaddr).substring(1)%></font>
  </span></TD></TR>
  <TR><TD>&nbsp;</TD>
  <TD>&nbsp</TD>
  <TD ALIGN="center">
  <span style="font-size: 10.0pt; font-family: Times New Roman">
    ...
    <TD>
  <span style="font-size: 10.0pt; font-family: Times New Roman">
   <font color=#990000>&pound;<%= cart.getGrandTotalString(orderaddr).substring(1)%></font>
  </span></TD></TR>
</TABLE>
<P>
...
<%= orderaddr.getCity() %>,  <%= orderaddr.getPostalCode() %><P>
