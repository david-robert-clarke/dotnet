...
public class BouncingBall extends JApplet implements ActionListener
{
    ...
    // On applet start up, initialise the following fields
    public void init()
    {
    ...
    // if an action is performed by any of the new ball menu items, deal with that
    // particular action in this method
	...
	// Looks at the current radio button selection to determine
	// the speed of the ball
	if(slowButton.isSelected()){vValue = 20;}
	else if(averageButton.isSelected()){vValue = 10;}
	else if(fastButton.isSelected()){vValue = 5;}
	...
	Object[] options = { "OK"};
	JOptionPane.showOptionDialog(null, "Some parameters are incorrect or have not " 
		             + "been specified", 
    ...
    // Calculates whether a ball has collided with a paddle. The direction of the ball
