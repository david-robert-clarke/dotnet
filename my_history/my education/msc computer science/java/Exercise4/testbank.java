...
class TestBank
{
	...
	OverdraftException
	{
		 ...
		 /*
		 Add more accounts than the array will take. 
		 ...
		 The list goes on .... 
		 Basically with the bank, common problems occur when removing accounts from the ends of the array (first/last) and when you try to over fill the array or remove all the elements. If your loop never reaches the end of the array or doesn't work if the array is full/empty, tests similar to the above will hopefully find these problems. 
		 */
