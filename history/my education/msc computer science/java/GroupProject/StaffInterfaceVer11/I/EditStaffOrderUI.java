...
/**
   The Edit Staff Order Interface
   
   This allows a manager to edit a staff order entry, 
   this class automatically updates the StaffOrder Tables

**/
class EditStaffOrderUI extends JFrame
{  
  private String sid;
  ...
  //Constructor
  public EditStaffOrderUI(String sLastName)
  {
  ...
  public class ButtonListener implements ActionListener
  {
	...
	System.out.println((String)staffEntry.get(0));
	System.out.println((String)staffEntry.get(1));
	System.out.println((String)staffEntry.get(2));
	System.out.println((String)staffEntry.get(3));
	System.out.println((String)staffEntry.get(4));
	System.out.println((String)staffEntry.get(5));
	System.out.println((String)staffEntry.get(6));
	System.out.println((String)staffEntry.get(7));
	System.out.println((String)staffEntry.get(8));
	System.out.println((String)staffEntry.get(9));
