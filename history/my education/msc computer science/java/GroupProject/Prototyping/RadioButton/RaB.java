...
public class RaB extends JPanel
    ...
    static String birdString = "Artist";
    static String catString = "Title";
    static String songString = "Song";
    ...
    public RaB() {
        ...
        JRadioButton songButton = new JRadioButton(songString);
        songButton.setMnemonic(KeyEvent.VK_C);
        songButton.setActionCommand(songString);
