...
public class CreditCard implements Cloneable {
    ...
    /**
     * Returns the credit card type of this card.
     *
    ...
    /**
     * Sets the credit card type of this card.
     *
     ...
     * was found to have an error during validating CreditCard,the error message
     ...
     * card number.
     *
     * @return true if the card passes the validation
	...
	CreditCard cc = null;
	    ...
	    try
		{
			...
			dbConn.prepareStatement(sql_bundle.getString("creditQuery"));
			...
			cc.setAddress(Address.findAddress(rs.getInt("ADDRESS_ID")));
		    } else {
		...
		{
		    System.out.println("Error during findCreditCard");
		    throw new CustomerActivityException();
		}
	    finally
		{
	...
	throws CustomerActivityException {
	    ...
	    try
		{
		    ...
		    PreparedStatement pstmt =
			dbConn.prepareStatement(sql_bundle.getString("creditInsert"));
			if (getCustomer()==null)
			{
		...
		{
		    System.out.println("Error during createCreditCard");
		    throw new CustomerActivityException();
		}
	    finally
		{
	...
	throws CustomerActivityException {
	    ...
	    try
		{
		    ...
		    PreparedStatement pstmt =
			dbConn.prepareStatement(sql_bundle.getString("creditUpdate"));
		    pstmt.setInt(1, getCustomer().getCustomerId());
		    pstmt.setString(2, getCardType());
		    pstmt.setString(3, getCardNumber());
		    pstmt.setString(4, getCardOwner());
		...
		{
		    System.out.println("Error during updateCreditCard");
		    throw new CustomerActivityException();
		}
	    finally
		{
	...
	throws CustomerActivityException {
	    ...
	    try
		{
		    ...
		    PreparedStatement pstmt =
			dbConn.prepareStatement(sql_bundle.getString("creditDelete"));
		...
		{
		    System.out.println("Error during deleteCreditCard");
		    throw new CustomerActivityException();
		}
	    finally
		{
