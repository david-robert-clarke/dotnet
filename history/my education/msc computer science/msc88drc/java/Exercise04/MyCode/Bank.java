	   ...
	   */
	   do
	   {
		  /*
			...
			then copy its' index and increment the no of free cells
		  */
	   ...
	   /*
	   	else if the number of available cells is greater than zero, place the 
		account in the last avialable cell
	   */
	   else if (freeCells > 0)
	   {
		   accounts[index] = a;
