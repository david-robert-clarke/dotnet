...
/**
   Used by EditContactDetailsUI, takes the staff ID number as an argument, 
   returns an arraylist of staff contact details for the current logged in
   staff member
...
public class GetStaffEntryQuery
{
  ...
  /**
   * Constructor to create a new get staff entry query
   *
   * @param staffID the staff ID number
   **/
   ...
   * Execute the Query
   *
   * @return an arraylist that contains the "logged in" staff members details
   **/
  public ArrayList exeQuery()
  {
	...
	staffArrayList.add(rs.getString("password"));
      }	
    } 
