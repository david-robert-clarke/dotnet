  ...
  **/
  ...
  {    
	...
	new GetStockDetailsQuery(cdArtist,cdTitle);
      ...
      stockEntries = getStockDetails.exeQuery();//returns the cds stock ntres
    ...
    public class ChoiceListener implements ActionListener
    {
      ...
      {
	System.out.println("ULTRA COMBO BOX!");
	int sI = supplierComboBox.getSelectedIndex();
	System.out.println("Selection: "+ sI);
	String a = (String)stockEntries.get(sI + 1);
	String b = (String)stockEntries.get(sI + 2);

	if(a != null)
	{
	  System.out.println("I'm before the setting");
	  wPriceTextField.setText(a);
	  numberItemsTextField.setText(b);
	  System.out.println("I'm after the setting");
	}
