...
public class AddCDTupleQuery
{
  ...
  {      
    c = MyConnection.C;
    cZhong = MyConnectionZhong.zhongC;//extra
    iid = "";
...
//cd_id      |      title      |   artist   | price |  pub_date  |   description    
