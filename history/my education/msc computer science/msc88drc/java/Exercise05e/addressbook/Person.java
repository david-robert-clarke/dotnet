...
public class Person
{
   ...
   * @param name the person's family name
   * @param names the person's given names
   * @param homeNo their home phone number
   * @param workNo their work phone number
   ...
   *
   * @param homeNo the home phone number
   **/
   ...
   *
   * @param workNo the mobile phone number
   **/
  ...
  {
    String line1 = "Name: " + getGivenNames() + " " 
      + getFamilyName() + "\n";
