...
public class Entry
{
	...
	// if the above equalities are true then this statement is never 
	// reached	
	    return false;
    }
	...
	// if nothing can be found on that particular line then throw an 
	// excepetion
	if (line == null || line.length() == 0)
	    {
		throw new BadRecordException("File contains fewer records than"
					     + "indicated in header.");
	    }
