...
public class Entry
{
	...
	// if nothing can be found on that particular line then throw an excepetion
	if (line.length() == 0)
	    {
		throw new BadRecordException("File contains fewer records than indicated in header.");
	    }
